    ...
    <div className="h-screen bg-gray-900 flex flex-col items-center justify-center p-2">
      <div className="w-full max-w-md bg-gray-800 p-4 rounded-xl shadow-lg">
        <div className="text-center mb-3">
          ...
          <p className="text-sm text-gray-400">Join NarrativeNest today</p>
        </div>
          ...
          <div>
            ...
            <div className="relative mt-1">
              ...
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 text-gray-400"
              >
                {showPassword.confirmation ? <EyeOff size={16} /> : <Eye size={16} />}
              </button>
            </div>
            {errors.password_confirmation && (
              <p className="text-xs text-red-500 mt-0.5">{errors.password_confirmation}</p>
            )}
          </div>
